...
abstract class AbstractRelationship implements InterfaceRelationship
{
	...
	{
		$condition_string = implode('_and_', is_array($condition_keys) ? $condition_keys : [$condition_keys]);
...
class HasMany extends AbstractRelationship
{
	...
	public function load_eagerly($includes, Table $table, $attributes=[], $models=[],)
	{
